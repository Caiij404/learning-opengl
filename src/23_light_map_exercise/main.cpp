...
int main(int argc, char *argv[])
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        boxShader.setBool("flag", flag);
        boxShader.setFloat("factor", factor);
